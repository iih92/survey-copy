			...
			<div class="thumbnails">
				...
				<div class="new">
					<h3>&nbsp;&nbsp;NEW SURVEY
						...
						<span id="deadLineup" 		<c:if test="${ lineupSession == '2' }">style=" font-weight:bold;" </c:if> >마감 임박</span>
						
						<span style="color:#ff8b02;">|</span> 
						
						<span id="hitLineup" 		<c:if test="${ lineupSession == '3' }">style=" font-weight:bold;" </c:if>>조회 수</span>  
						<span style="color:#ff8b02;">|</span> 
						</span>
