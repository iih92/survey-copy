     	...
     	$(document).ready(function(){    
         	...
         	$("#radio").click(function(){
            	...
            	$("#div"+cnt).append("<div id=input"+cnt+"></div><br>");
           		...
           		$("#input"+cnt).append("<font class='Q'>Q</font> <input type='text' class='question_input' placeholder='질문'> <br>");        		
            ...
            $(document).on('click','#addR',function(){
            	...
            	var group = $(this).attr("name");
              	...
              	$("#input"+group).append("<input type='text' id=radio"+numR+" name="+group+">");
            ...
            /*------------------------------------ TextArea Start ------------------------------------------*/
     		// 주관식 div 생성
   			$("#text").click(function(){
              	...
              	$("#div"+cnt).append("<font class='Q'>Q</font> <input type='text' class='question_input' placeholder='질문' name="+cnt+"> <br>");  
	...
	<div class="container">
		...
		<form action="#">
			<div id="form" class="main">
				<!--제목-->
		        <div class="title"> <input type="text" class="title_input" placeholder="나만의 설문 만들기"> </div>
			</div>
		</form>
	</div>
</body>
