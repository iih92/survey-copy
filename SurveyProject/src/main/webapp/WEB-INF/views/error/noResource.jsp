        ...
        <div class="row">
            <div class="col-md-12 ">
                <div class="error-text">
                    ...
                    <h4>요청한 페이지를 찾을 수 없습니다 :P</h4>
                    <p>죄송합니다. 찾으시려는 페이지의 주소가 잘못 입력되었거나, 페이지 주소의 변경 혹은
                    	삭제로 인해 현재 사용하실 수 없습니다.<br>
                   		 입력하신 페이지의 주소가 정확한지 다시 한번 확인해 주시길 부탁드립니다.</p>
                    <a href="/survey/mainpage" class="btn btn-primary btn-round">Go to mainpage</a>
                </div>
            </div>
        </div>
    </div>
