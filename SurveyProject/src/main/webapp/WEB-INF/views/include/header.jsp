		...
		<div class="container">
			...
			<div class="menu">
				...
				<c:choose>
					...
					<c:otherwise>
						<div class="middle">
							<font size="4px">Welcome!</font> <font style="color: #00ebfc">
								${loginUser}</font>님 반갑습니다.
						</div>
					</c:otherwise>
				</c:choose>
				...
				<div class="headermenu">
					<ul class="menugroup">
						...
						<c:choose>
							<c:when test="${loginUser == null}"></c:when>
							<c:otherwise>
								<li class="link"><a href="signOut" class="hmenu">Sign
										out</a></li>
							</c:otherwise>
						</c:choose>
						<li class="link"><button class="makeform" type="submit">START</button></li>
						<li class="link"><button class="search">
